...
//import com. moviebookingapp.kafka.KafkaProducerConfig;
...
//    private KafkaTemplate kafkaTemplate;
    ...
    void getAllMoviesAndNoneFound() throws Exception {
        ...
        // expects the response status of 404 not found when no movies are found
...
//    }
    ...
    public void testGetMovieByNameAndFound() throws Exception {
        ...
        // Use MockMvc to send a GET request to the /api/v1.0/moviebooking//movies/search/{movieName} endpoint using the mockmvc 
        // expects the response status of 200 ok when movies are search by movieName
